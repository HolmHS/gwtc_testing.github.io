...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['1730398334_GW151012_GWTC-1'] = ['luminosity_distance', 'ra', 'dec', 'mass_1', 'mass_2', 'a_1', 'a_2', 'log_likelihood', 'theta_jn', 'tilt_1', 'tilt_2', 'redshift', 'mass_ratio', 'total_mass', 'chirp_mass', 'symmetric_mass_ratio', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'chi_eff', 'chi_p'];
    ...
    var data = {}
    data['1730398334_GW151012_GWTC-1'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
