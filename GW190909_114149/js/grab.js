...
function grab_html(param, label="None") {
    ...
    */
    ...
    if ( label == "switch") {
        ...
        if ( param == "C01:IMRPhenomD" ) {
            approx = "None" 
        }
        if ( param == "C01:IMRPhenomPv2" ) {
            approx = "None" 
        }
        if ( param == "C01:SEOBNRv4P" ) {
            approx = "None" 
        }
        if ( param == "C01:SEOBNRv4PHM" ) {
            approx = "None" 
        }
        if ( param == "PrecessingSpinIMR" ) {
            approx = "None" 
        }
        if ( param == "PrecessingSpinIMRHM" ) {
            approx = "None" 
        }
        if ( param == "PublicationSamples" ) {
            approx = "None" 
        }
        if ( param == "ZeroSpinIMR" ) {
            approx = "None" 
        }
